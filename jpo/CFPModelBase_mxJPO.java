...
//							")";
	...
	public MapList getManagedRevisions(Context context, String[] args)
		...
		try {
			...
			/*int iLevel =${CLASS:ManufacturingPlan}.getLevelfromSB(context,args);
			int iLimit = ${CLASS:ManufacturingPlan}.getLimit(context,args);*/
			int iLevel = JPO.invoke(context, "ManufacturingPlan", null, "getLevelfromSB", args);
			int iLimit = JPO.invoke(context, "ManufacturingPlan", null, "getLimit", args);
	...
	public MapList getMasterComposition(Context context, String[] args)
		...
		/**
	  	 * 
	  	 * Checks for CompositionMatrix expression + Mobile Mode And FTR/PLC License. Returns True if Mobile Mode is Enabled or User doesn't have either of Licenses (FTR or PLC). 
	  	 * @param context 
	  	 * 			the eMatrix <code>Context</code> object
	  	 * @param args 
	  	 ...
	  	 * 			If the operation fails
	  	 */
	  	 public boolean isAuthoringModeDisabled (Context context, String args[]) throws FrameworkException { 
	  		boolean isMobileModeEnabled = UINavigatorUtil.isMobile(context);
	  		boolean isCompositionMatrixEnabled = /*false;*/!com.dassault_systemes.enovia.governance.modeler.GovernanceModelerServices.isCompositionMatrixEnabled(context);
			//System.out.println("-------------------------------------------->In isAuthoringModeDisabled:isCompositionMatrixEnabled "+isCompositionMatrixEnabled);
	  		...
	  		if(isMobileModeEnabled || !isFTRUser || isCompositionMatrixEnabled ){
	  			return true;
	  		}
	  		return false;
	   	...
	   	/**
	   	 * 
	   	 *Checks for CompositionMatrix expression + Mobile Mode And FTR/PLC License. Returns True if Mobile Mode is Disabled And User has either of Licenses (FTR or PLC).
	   	 * @param context 
	   	 * 			the eMatrix <code>Context</code> object
	   	 * @param args 
	   	 * 			string array containing packed arguments.
	   	 ...
	   	 * 			If the operation fails
	   	 */
	   	 public boolean isAuthoringModeEnabled (Context context, String args[]) throws FrameworkException { 
	  		boolean isMobileModeEnabled = UINavigatorUtil.isMobile(context);
	  		boolean isCompositionMatrixEnabled = /*true;*/com.dassault_systemes.enovia.governance.modeler.GovernanceModelerServices.isCompositionMatrixEnabled(context);
			//System.out.println("-------------------------------------------->In isAuthoringModeEnabled:isCompositionMatrixEnabled "+isCompositionMatrixEnabled);
	   		boolean isFTRUser=false;
	   		String Licenses[] = {"ENO_FTR_TP","ENO_PLC_TP"};
	   		try {
	   			FrameworkLicenseUtil.checkLicenseReserved(context,Licenses);
	   		...
	   		if(!isMobileModeEnabled && isCompositionMatrixEnabled && isFTRUser){
	   			return true;
	   		}
	   		return false;
	   	 }	  	 
