...
// End Changes  for  IR Mx376196
	...
	// End Chnages  for  IR Mx376196
        ...
        public List getProductRuleExpression(Context context, String[] args,String strRelType,String strRuleDisplay) throws Exception {
            ...
            StringList lstLeftExpressionList = new StringList();
            ...
            StringList lstRelationSelects = new StringList();
            ...
            StringList lstProductTNR = new StringList();
            StringList lstOperator = new StringList();
            try
            {
	...
	// End -Changes  for  IR Mx376196
            ...
            StringList lstLeftExpressionList = new StringList(iNumOfObjects);
...
public List showInclusionRuleExpression(Context context, String[] args) throws Exception
 {
		...
		for (int i = 0; i < objectList.size(); i++) {
			...
			Object slRuleTypeObj = (Object) objectMap.get("tomid["
					...
					+ "].from["+ConfigurationConstants.TYPE_INCLUSION_RULE+"].type");
    ...
    throws Exception
{
	...
	throws Exception
	{
		...
		StringList lstFinalResult = new StringList();
    ...
    List allObjList = dom.getRelatedObjects(
		...
		StringList lstCompOperator = new StringList();
		StringList lstCompOption = new StringList();
		...
		if(strReportFormat!=null
			...
			StringList lstReportList = new StringList();
	...
	private String removeDuplicate(
			...
			{
		StringList lstTemp = new StringList();
	...
	public List getCompatibilityOption(Context context, String[] args) throws Exception
	{
		...
		StringList lstCmpOption = new StringList(iNumOfObjects);
	...
	public List showInclusionRuleExpressionForProductContext(Context context, String[] args) throws Exception
	 {
			...
			String[] relIdsArray = new String[objectList.size()];
			for (int i = 0; i < objectList.size(); i++) {
				// Get the Relationship IDs
				relIdsArray[i] = (String) ((Map) objectList.get(i)).get(DomainRelationship.SELECT_ID);
			}

			MapList relMapList = DomainRelationship.getInfo(context, relIdsArray, slRelSelects);
			HashMap mapRelRE = new HashMap();
			for(Object obj: relMapList)
			{
				Map map = (Map)obj;
				mapRelRE.put(map.get(DomainRelationship.SELECT_ID), map.get("tomid["+ConfigurationConstants.ATTRIBUTE_LEFT_EXPRESSION+"].from["+ConfigurationConstants.TYPE_INCLUSION_RULE+"].attribute["+ConfigurationConstants.ATTRIBUTE_RIGHT_EXPRESSION+"].value"));
			}
			...
			for (int i = 0; i < objectList.size(); i++) 
			{
				...
				if (isRootNode != null) {
					...
					strIncRuleRE = (String)mapRelRE.get(strRelId);
