 ...
 * @version 2012
 */
public class emxSortHTMLAlphaNumericFTRBase_mxJPO extends emxCommonBaseComparator_mxJPO
{
    ...
    public emxSortHTMLAlphaNumericFTRBase_mxJPO (Context context, String[] args)
        throws Exception
    {
    ...
    public emxSortHTMLAlphaNumericFTRBase_mxJPO ()
    {
    }
