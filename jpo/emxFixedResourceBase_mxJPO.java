  ...
  public MapList getAllFixedResourcesInUsage(Context context, String[] args) throws Exception
    {
     ...
     lstMultiValueList.add("to["+ ConfigurationConstants.RELATIONSHIP_RESOURCE_USAGE +"].id");
     lstMultiValueList.add("to["+ ConfigurationConstants.RELATIONSHIP_RESOURCE_USAGE +"].name");
     lstMultiValueList.add("to["+ ConfigurationConstants.RELATIONSHIP_RESOURCE_USAGE +"].attribute["+ ConfigurationConstants.ATTRIBUTE_SUBFEATURECOUNT +"]");
     lstMultiValueList.add("to["+ ConfigurationConstants.RELATIONSHIP_RESOURCE_USAGE +"].to.id");
     lstMultiValueList.add("to["+ ConfigurationConstants.RELATIONSHIP_RESOURCE_USAGE +"].fromrel.from.name");
     lstMultiValueList.add("to["+ ConfigurationConstants.RELATIONSHIP_RESOURCE_USAGE +"].fromrel.to.name");
     lstMultiValueList.add("to["+ ConfigurationConstants.RELATIONSHIP_RESOURCE_USAGE +"].fromrel.from.attribute["+ ConfigurationConstants.ATTRIBUTE_DISPLAY_NAME +"]");
     lstMultiValueList.add("to["+ ConfigurationConstants.RELATIONSHIP_RESOURCE_USAGE +"].fromrel.from.attribute["+ ConfigurationConstants.ATTRIBUTE_MARKETING_NAME +"]");
     lstMultiValueList.add("to["+ ConfigurationConstants.RELATIONSHIP_RESOURCE_USAGE +"].fromrel.to.attribute["+ ConfigurationConstants.ATTRIBUTE_DISPLAY_NAME +"]");
     lstMultiValueList.add("to["+ ConfigurationConstants.RELATIONSHIP_RESOURCE_USAGE +"].fromrel.to.attribute["+ ConfigurationConstants.ATTRIBUTE_MARKETING_NAME +"]");
 	 
     DomainObject ResourceRuleObject = new DomainObject(strResourceId);
     Map mapOfRelIds = ResourceRuleObject.getInfo(context, strSelect, lstMultiValueList);
