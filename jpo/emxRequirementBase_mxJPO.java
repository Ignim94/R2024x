...
11-Oct-2022     VAI1        ZUD     2022x   Before calling Method, must use annotations, If a method is not annotated correctly, then BPS does not call the method
13-Oct-2023		AGT11		LVA		2023x	FUN130134 - Enable Non Linear Revision for all Requirement corpus type
...
//End IR-187552V6R2014 LX6				
    ...
    public int revisedParentRequirement(Context context, String[] args)throws Exception
    {
        ...
        try
        {
            ...
            DomainObject domRevisedObject = RequirementsCommon.getLastRevision(context, strObjectId); // Remove of the third arg, not used anymore: , "MajorRevision".equalsIgnoreCase(event)
