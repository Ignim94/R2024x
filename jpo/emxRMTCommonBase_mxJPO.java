...
/*
  ...
  13-OCT-23 AGT11 LVA :FUN130134 - Enable Non Linear Revision for all Requirement corpus type
  06-NOV-23 AGT11 GVC :FUN130134 - Fix Reg on BPS App for highest revision indicator
*/
...
//  End:R207:RMT Bug 357905
  ...
  {
      return ReqServices.getMajorRevisionList(context, objectId);
  }
  ...
  public boolean isLastRevision(Context context, String objectId)
    throws FrameworkException
    {
      ...
      try
      {
        ...
        String lastObjectId = lastRevision.getInfo(context, DomainConstants.SELECT_ID);
        return objectId.equals(lastObjectId) || objectId.equals(lastRevision.getPhysicalId(context));
      }
      catch (Exception e)
      {
        throw (new FrameworkException(e));
  ...
  public int updateProgramAttribute(Context context, String[] args, boolean isBus, boolean isColumn) throws Exception
    {
      ...
      if(isBus){
           ...
           && "relationship_DerivedRequirement".equalsIgnoreCase((String)requestMap.get("reportRelationships")))
        {
          ...
          JPO.invoke(context, "emxRMTConnect", null, "modifyLinkStatusValue", JPO.packArgs(args1),null);
        }
        //-- IR-620577-3DEXPERIENCER2018x fix --
