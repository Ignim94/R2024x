...
//					strPFLRelPattern,strSelect, sBufWhereCond.toString());
			...
			strSelect1.add(DomainConstants.SELECT_CURRENT);
			...
			Map mPFLDetails = domProduct.getInfo(context, strSelect1, lstMultiValueList);
			...
			strProductState = (String) mPFLDetails.get(DomainConstants.SELECT_CURRENT);
			// Added for Frozen State Mapping function Changes.
    		// Product which is in Frozen State then below code will get invoked.
            ...
            String language  = context.getSession().getLanguage();
            if(listFrozenStates.contains(strProductState)){
