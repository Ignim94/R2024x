  ...
  public class emxVariantConfigurationIntermediateObjectMigrationBase_mxJPO extends emxCommonMigration_mxJPO
  {
      ...
      private void  migrateFeatures(Context context, StringList objectIdList)throws Exception{
		...
		return;
    	  ...
    	  try{
    			  ...
    			  lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].id");
    			  lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].from.id");
    			  lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].from.name");
    			  lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].attribute["+ATTRIBUTE_INAVLID_CONTEXTS+"]");
    			  lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].attribute["+ConfigurationConstants.ATTRIBUTE_EFFECTIVITY_STATUS+"]");
    			  lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].attribute["+ConfigurationConstants.ATTRIBUTE_ACTIVE_COUNT+"]");
    			  lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].attribute["+ConfigurationConstants.ATTRIBUTE_INACTIVE_COUNT+"]");
    			  lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].attribute["+ATTRIBUTE_USER_DEFINED_EFFECTIVITY+"]");

                  MapList mapList = DomainObject.getInfo(context, oidsArray, featureObjSelects, lstMultiValueList);
		...
		mqlLogRequiredInformationWriter("GBOM migration done\n");
    	  ...
    	  try {
			...
			mqlLogRequiredInformationWriter("Migration Status set to GBOMInProcess\n");
    				  ...
    				  StringList lstMultiValueList = new StringList();
    				  lstMultiValueList.add("to[" + ConfigurationConstants.RELATIONSHIP_GBOM_FROM+ "].id");

    	              MapList mapList = DomainObject.getInfo(context, oidsArray, gbomObjSelects, lstMultiValueList);
    	              Iterator itr = mapList.iterator();
	...
	if ((objectIdList == null || objectIdList.size() <= 0) && (migrationStatus == 9 || migrationStatus == 10 )) {		
		...
		mqlLogRequiredInformationWriter("Migration Status set to RuleInProcess" + "\n");
                 ...
                 StringList lstMultiValueList = new StringList();
                 lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_LEFT_EXPRESSION+ "].id");
                 lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION+ "].id");
                 lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_RIGHT_EXPRESSION+ "].to.id");
		         //DomainConstants.MULTI_VALUE_LIST.add(ConfigurationConstants.SELECT_DESIGNVARIANTS);


                 MapList mapList = DomainObject.getInfo(context, oidsArray, objectSelects, lstMultiValueList);
                 Iterator itr = mapList.iterator();
  ...
  private String replaceIntermediateObjectWithRel(Context context, String strOldRelId ,String strNewRelId ,String strNewRelIdSide,Map attributeMap) throws Exception {
    ...
    throws Exception{
		...
		if((StringList)featObjMap.get("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].id")!=null){
			...
			lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].from.id");
			lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].from.name");
			lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].from.type");
			lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].attribute["+ATTRIBUTE_INAVLID_CONTEXTS+"]");
			lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].attribute["+ConfigurationConstants.ATTRIBUTE_EFFECTIVITY_STATUS+"]");
			lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].attribute["+ConfigurationConstants.ATTRIBUTE_ACTIVE_COUNT+"]");
			lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].attribute["+ConfigurationConstants.ATTRIBUTE_INACTIVE_COUNT+"]");
			lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_VARIES_BY+"].attribute["+ATTRIBUTE_USER_DEFINED_EFFECTIVITY+"]");
			  ...
			  Map MFeatObj = domFd.getInfo(context, objSel, lstMultiValueList);
    ...
    throws Exception{
    	...
    	try{
    		...
    		if(strParentFeatureType!=null
    			...
    			StringList lstMultiValueList = new StringList();
    			lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST+ "].torel.to.from["+ ConfigurationConstants.RELATIONSHIP_VARIES_BY+ "].to.type");
    			lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST+ "].to.from["+ ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO+ "].to.from["+ ConfigurationConstants.RELATIONSHIP_VARIES_BY+ "].to.type");
    			lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST+ "].id");
    			lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST+ "].frommid["+ ConfigurationConstants.RELATIONSHIP_INACTIVE_VARIES_BY+ "].id");
    			lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST+ "].to.from["+ ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO+ "].to.id");
    			lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_PRODUCT_FEATURE_LIST+ "].to.from["+ ConfigurationConstants.RELATIONSHIP_FEATURE_LIST_TO+ "].to.name");

    			Map featureListMapList = domPVId.getInfo(context,sLRelSelects, lstMultiValueList);
