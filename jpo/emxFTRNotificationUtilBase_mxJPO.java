...
public class emxFTRNotificationUtilBase_mxJPO extends emxPLCNotificationUtil_mxJPO
{
   ...
   {
	   	//IR-951704-3DEXPERIENCER2023x - check and skip if it's not for the purpose
		String skip = PropertyUtil.getGlobalRPEValue(context,"SKIP_OPTIONS_TRANS_NOTIFICATION");
   ...
   public static int notifyOnEngineeringChangeRaisedEvent(Context context, String[] args) throws Exception
   {
          ...
          mxType.isOfParentType(context, toType, ConfigurationConstants.TYPE_TEST_CASE))
      {
         ...
         /*result = (${CLASS:emxNotificationUtil}.objectNotification(context, args));*/
    	  result = JPO.invoke(context, "emxNotificationUtil", null, "objectNotification", args);
      }
