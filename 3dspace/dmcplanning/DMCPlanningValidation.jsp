...
function checkValuesAndApply()
{
	...
	var urlParam = "mode=checkDesignChangeConfirm"+
            "&effectivityselections="+encodeURIComponent(sl)+
    		...
    		if(trim(bdesignChange)== "true")
            {
					...
					{
						emxUICore.getDataPost("../dmcplanning/DesignEffectivityUtil.jsp?mode=create&PRCFSParam2="+strAction1+"&effectivityselections="+encodeURIComponent(sl)+
