...
<%
    String applicableOrg = "";
    String criteriaID = emxGetParameter(request,"objectId");
    if (criteriaID != null && !"".equals(criteriaID)) {
        Map orgMap = CriteriaUtil.getApplicableOrganization(context, criteriaID);
        applicableOrg = ((StringList)orgMap.get("orgs")).join(CriteriaConstants.PIPE);
    }
%>
//XSSOK
var APPLICABLE_ORG = "<%=applicableOrg %>";
