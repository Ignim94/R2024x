...
<%
	 ...
	 if("ProjectTemplateTableViewNameColumn".equalsIgnoreCase(strMode)){
    	 //To open tree menu for Gate and Task accordingly 
    	 String contentURL = "";
...
<%
       ...
       String[] methodArgs = JPO.packArgs(paramMap);
		...
		if("PMCProjectTemplateWBSDataGridView".equalsIgnoreCase(subMode)) {
			...
			if(ProgramCentralUtil.isNotNullString(treeLabel)){
