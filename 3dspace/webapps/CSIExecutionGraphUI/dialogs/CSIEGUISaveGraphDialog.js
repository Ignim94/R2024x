...
define("DS/CSIExecutionGraphUI/dialogs/CSIEGUISaveGraphDialog", ["require", "exports", "DS/EPSSchematicsUI/dialogs/EPSSchematicsUIBaseDialog", "DS/EPSSchematicsUI/tools/EPSSchematicsUIDom", "DS/EPSSchematicsUI/tools/EPSSchematicsUIFileSaver", "DS/EPSSchematicsUI/tools/EPSSchematicsUITools", "DS/Controls/Button", "DS/Controls/TooltipModel", "DS/CSIExecutionGraphUI/tools/CSIEGUITools", "DS/CSIExecutionGraphUI/dialogs/CSIEGUISaveRecordBasicDialog", "DS/CSIExecutionGraphUI/dialogs/CSIEGUISaveRecordAdvancedDialog", "css!DS/CSIExecutionGraphUI/sass/dialogs/CSIEGUISaveGraphDialog"], function (require, exports, UIBaseDialog, UIDom, UIFileSaver, UITools, WUXButton, WUXTooltipModel, CSIEGUITools, CSIEGUISaveRecordBasicDialog, CSIEGUISaveRecordAdvancedDialog) {
    "use strict";
    ...
    class CSIEGUISaveGraphDialog extends UIBaseDialog {
        ...
        _onCreateContent() {
            ...
            this._content.appendChild(UITools.createJSONVersionElement(this._editor));
        }
        ////////////////////////////////////////////////////////////////////////////////////////////////////
