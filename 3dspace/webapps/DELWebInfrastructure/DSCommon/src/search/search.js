...
/* @Prototype */
{
  ...
  displayResults : function(objData) {
    ...
    if(objData.html) {
      ...
      this._resultsElement.closest('.ui-dialog').find('.ui-dialog-titlebar-close').contents().filter(function() { return this.nodeType === Node.TEXT_NODE && $.trim(this.nodeValue).length > 0; }).remove();
