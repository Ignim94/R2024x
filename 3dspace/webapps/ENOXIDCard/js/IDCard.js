         ...
         _checkAttributesOverflow: function () {
            ...
            for (var k = 0; k < columns.length; k++) {
                ...
                if(columns[k+1] && that.container.getElement('.free-zone-0')){
                    ...
                    var isNextHidden = columns[k+1].classList.contains('hidden') && that.container.getElement('.free-zone-0').classList.contains('hidden');
                }else if(that.container.getElement('.free-zone-0')){
                    // if it is the last column, we just check if the freezone is hidden 
                    var isNextHidden = that.container.getElement('.free-zone-0').classList.contains('hidden');
                }            
                if(!isHidden){
