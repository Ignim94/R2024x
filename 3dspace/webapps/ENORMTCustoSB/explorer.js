...
// @quickreview CGA5 KIE1 22:08:17 	  : IR-960370 , Changes in structureExplorerMenu , URL Encoded issue.
// @quickreview ZUD      : 12/07/2023 : IR-1176595 , added escapeHTML for XSS Vulnerability
/*****************************************************************************/
/*****************************************************************************/
...
function structureExplorerMenu(event) {
    ...
    var encodedBitwiseOROperator = encodeURIComponent('|');
	/* Root objectId - - - - - r attribute | o attribute | root obkjectId | id attribute */
    // Changed '|' to encodeURIComponent('|') , Encoded - format of URL , ++-- CGA5 , IR-960370
	...
	targetObject.getAttribute('r') + encodedBitwiseOROperator+ targetObject.getAttribute('o') + encodedBitwiseOROperator + 
	rootObjectId + encodedBitwiseOROperator+ targetObject.getAttribute('id') + '&appendRMBMenu=' + jQuery('#treeBodyTable').find('.root-node').find('td')[1].getAttribute('rmb');
