...
define("DS/EPSSchematicsCSI/EPSSchematicsCSIImport", ["require", "exports", "DS/EPSSchematicsModelWeb/EPSSchematicsTools", "DS/EPSSchematicsModelWeb/EPSSchematicsModelEnums", "DS/EPSSchematicsModelWeb/EPSSchematicsTypeLibrary", "DS/EPSSchematicsModelWeb/EPSSchematicsBlockLibrary", "DS/EPSSchematicsModelWeb/EPSSchematicsGraphContainerBlock", "DS/EPSSchematicsModelWeb/EPSSchematicsContainedGraphBlock", "DS/EPSSchematicsModelWeb/EPSSchematicsInvalidBlock", "DS/EPSSchematicsCoreLibrary/flow/EPSIfBlock", "DS/EPSSchematicsCoreLibrary/flow/EPSSyncFlowsBlock", "DS/EPSSchematicsCoreLibrary/flow/EPSJoinAllBlock", "DS/EPSSchematicsCoreLibrary/flow/EPSOnlyOneBlock", "DS/EPSSchematicsCoreLibrary/calculator/EPSAddBlock", "DS/EPSSchematicsCoreLibrary/calculator/EPSDivideBlock", "DS/EPSSchematicsCoreLibrary/calculator/EPSIsEqualBlock", "DS/EPSSchematicsCoreLibrary/calculator/EPSMultiplyBlock", "DS/EPSSchematicsCoreLibrary/calculator/EPSSetValueBlock", "DS/EPSSchematicsCoreLibrary/calculator/EPSSubstractBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayConcatBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayFilterBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayGetBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayGetIndexBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayInsertBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayIteratorBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayLengthBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayMapBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayPopBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayPushBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayRemoveBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArraySetBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayShiftBlock", "DS/EPSSchematicsCoreLibrary/array/EPSArrayUnshiftBlock", "DS/EPSSchematicsCSI/EPSSchematicsCSITools", "DS/EPSSchematicsCSI/EPSSchematicsCSIGraphBlock", "DS/EPSSchematicsCSI/EPSSchematicsCSIJavaScriptBlock", "DS/EPSSchematicsCSI/EPSSchematicsCSIPythonBlock", "DS/EPSSchematicsCSI/typings/CSICommandBinder/EPSSCSICommandBinder", "DS/EPSSchematicsModelWeb/EPSSchematicsDynamicBlock", "DS/EPSSchematicsModelWeb/EPSSchematicsGraphBlock"], function (require, exports, Tools, Enums, TypeLibrary, BlockLibrary, GraphContainerBlock, ContainedGraphBlock, InvalidBlock, IfBlock, SyncFlowsBlock, JoinAllBlock, OnlyOneBlock, AddBlock, DivideBlock, IsEqualBlock, MultiplyBlock, SetValueBlock, SubstractBlock, ArrayConcatBlock, ArrayFilterBlock, ArrayGetBlock, ArrayGetIndexBlock, ArrayInsertBlock, ArrayIteratorBlock, ArrayLengthBlock, ArrayMapBlock, ArrayPopBlock, ArrayPushBlock, ArrayRemoveBlock, ArraySetBlock, ArrayShiftBlock, ArrayUnshiftBlock, CSITools, CSIGraphBlock, CSIJavaScriptBlock, CSIPythonBlock, CSICommandBinder, DynamicBlock, GraphBlock) {
    ...
    (function (CSIImport) {
        ...
        function buildFromJSONObject(oGraphBlock, iCSIJSONObject) {
            ...
            if (iCSIJSONObject.implementation.version > 1) {
                if (iCSIJSONObject.progress !== undefined) {
                    csiImportDataPortFromSignature(oGraphBlock.getDataPortByName('Progress'), iCSIJSONObject.progress);
                }
                if (iCSIJSONObject.throwError !== undefined) {
                    csiImportDataPortFromSignature(oGraphBlock.getDataPortByName('Error'), iCSIJSONObject.throwError);
                }
            }
