                    ...
                    //if (AutoRenameActivated == null) {
                        ...
                        WAFData.authenticatedRequest(url, {
                            ...
                            onComplete: function (payload) {
                                ...
                                var array_ops = ["TRUE", "NEW", "REVISE", "DUPLICATE", "SAVEASNEW","NEWBRANCH"];
                                
								// Filename validation is done for NEW
								// And we decided to always have Unique Filename functionality if at least one of the operation is activating Unique Filename
                                var activated = array_result.some(r => array_ops.includes(r));
                                
                                that.cache_data["AutoRenameActivated"] = activated;
