    ...
    var FoundationAjax = {
        ...
        getParams: function() {
            ...
            if(prefs['scopeObjectData']){
                if(prefs['scopeObjectData']['contextFilter'] && prefs['scopeObjectData']['serviceId'] === "3DSpace"){
        ...
        setupEnoviaServer: function setupEnoviaServer(options) {
            ...
            window.enoviaServer = {
                ...
                timezone: timezone,
                _getUrl: function() {
            		if (window.enoviaServer.tempURI) {
            			return window.enoviaServer.tempURI;
            		} else if (lOptions.getUrl) {
            			return lOptions.getUrl();
            		}
            		return this.storageUrl || this.sRealURL;
            	},
                getParams: FoundationAjax.getParams,
                getParamsAsJSON: FoundationAjax.getParamsAsJSON,
                setTempUrl:function(url){
                    return window.enoviaServer.tempURI = url
                },
