define('DS/StudioIV/StuXRGrab',
	['DS/StuCore/StuContext', 'DS/StuModel/StuBehavior', 'DS/EPTaskPlayer/EPTask', 'DS/StuCore/StuTools', 'DS/EP/EP', 'DS/EPEventServices/EPEvent', 'DS/MathematicsES/MathsDef', 'DS/StudioIV/StuXRManager'],
	function (STU, Behavior, Task, Tools, EP, EventServices, DSMath, XRManager) {
		'use strict';
