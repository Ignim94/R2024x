      ...
      <vu-modal :title="$i18n('newCall')" show @close="closeModal" noMobile="false">
        ...
        <template #modal-footer>
          <div v-if="isDialerComponent == false">
            <vu-btn color="primary start-call-btn" @click="startCallWithSelectedContacts(false)" :disabled="callHistoryStore.selectedContact.length == 0">
            ...
            <vu-dropdownmenu class="startcall-dropdown" :items="callDropdownItems" position="bottom-right"
              ...
              <vu-btn color="primary" class="start-call-dropdown-btn" :disabled="callHistoryStore.selectedContact.length == 0">
