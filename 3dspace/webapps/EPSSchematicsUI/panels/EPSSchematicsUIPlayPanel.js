...
define("DS/EPSSchematicsUI/panels/EPSSchematicsUIPlayPanel", ["require", "exports", "DS/EPSSchematicsUI/panels/EPSSchematicsUIPanel", "DS/EPSSchematicsUI/tools/EPSSchematicsUIDom", "DS/EPSSchematicsUI/tools/EPSSchematicsUITools", "DS/EPSSchematicsUI/tools/EPSSchematicsUIFontIcon", "DS/EPSSchematicsUI/tools/EPSSchematicsUIWUXTools", "DS/EPSSchematicsUI/data/EPSSchematicsUIKeyboard", "DS/EPSSchematicsUI/tools/EPSSchematicsUIEvents", "DS/EPEventServices/EPEventServices", "DS/EPSSchematicEngine/EPSSchematicsExecutionEvents", "DS/Controls/Button", "DS/Controls/Expander", "DS/Controls/Toggle", "DS/Core/WebUXGlobalEnums", "css!DS/EPSSchematicsUI/css/panels/EPSSchematicsUIPlayPanel"], function (require, exports, UIPanel, UIDom, UITools, UIFontIcon, UIWUXTools, UIKeyboard, UIEvents, EventServices, ExecutionEvents, WUXButton, WUXExpander, WUXToggle, WebUXGlobalEnums_1) {
    "use strict";
    ...
    class UIPlayPanel extends UIPanel {
        ...
        constructor(editor) {
            ...
            this._onJSONVersionChangeCB = this._onJSONVersionChange.bind(this);
            this._editor = editor;
        ...
        _onClose() {
            ...
            if (this._editor.getOptions().playCommands.displayVersion) {
                this._editor.removeListener(UIEvents.UIJSONVersionChangeEvent, this._onJSONVersionChangeCB);
            }
            this._startButton = undefined;
            this._stopButton = undefined;
            this._debugExpander = undefined;
        ...
        _createContent() {
            ...
            if (this._editor.getOptions().playCommands.displayVersion) {
                this.getContent().appendChild(UITools.createJSONVersionElement(this._editor, true));
                this._editor.addListener(UIEvents.UIJSONVersionChangeEvent, this._onJSONVersionChangeCB);
            }
        ...
        /**
         * The callback on the JSON Version change event.
         * @private
         */
        _onJSONVersionChange() {
            const jsonVersionSwitch = this.getContent().querySelector('.csiegui-content-version .wux-controls-toggle');
            if (jsonVersionSwitch) {
                jsonVersionSwitch.dsModel.checkFlag = this._editor._getJSONVersion() === 2;
            }
        }
    }
    return UIPlayPanel;
