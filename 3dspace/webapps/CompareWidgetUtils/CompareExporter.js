...
//      columns_to_remove: ['tree', 'find_in_ctx', 'hide_show', 'bi_color'],
   ...
   */
      outHeader: function (options, columns) {
          ...
          if (options.structDisplayStyle == 'MULTI'){
              
              if(options.showLevel == true){
                  columns.push(NLSCE["Depth"]);                  
              } 
              
              if(options.showQuant == true){
        ...
        if ((options.structDisplayStyle == 'MULTI') && (options.showLevel == true) ||
            (options.outputAttributeDifferences && options.structDisplayStyle != "list")) {
