 ...
 * @quickreview RMI21 ZUD 2024:02:26 IR-1197326-3DEXPERIENCER2024x: Enabling drop only when drop data is not of type 'text/plain'
    ...
    CKEDITOR.plugins.add('rcowidget',{
        ...
        init: function(editor) {
            ...
            editor.on('paste', function(event) {
                ...
                let dataTransfer = event.data.dataTransfer.$;
                if(event.data.method === 'drop' && dataTransfer.types.includes('text/plain')) {
                    event.cancel();
                    return;
                }
