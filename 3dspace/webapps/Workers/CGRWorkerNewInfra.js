    ...
    require(["DS/Formats/CGRFile"], function(CGRFile) {
        ...
        workerContext.onmessage = function(e) {
            ...
            function openCGR(byteArray) {
                ...
                var cgrFile = new CGRFile(byteArray, expand, primWithBS, withSG, udlMode, i32Idx, smartStaticBatching, withSAG, processText, sagInfo, withBagUUID, repWithBS, optimizeCurvedPipes, withBlanking, useDefaultTCSet, sceneGraphOrderMode, mode2D);
