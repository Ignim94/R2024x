    ...
    while(itr.hasNext()){
    	...
    	if(!tempParams.contains(paramName)){
        	...
        	if(objValue instanceof String){
        		//Modified  IR-1275171-3DEXPERIENCER2022x -- Added xss encoding for paramName
    			tempURLParameters.append(XSSUtil.encodeForURL(context, paramName)).append("=").append(XSSUtil.encodeForURL(context, (String)objValue)).append("&amp;");
        	}
    	}
    }
