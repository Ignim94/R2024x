...
function updateTerminalInputFields(inputKey) {
    ...
    newValue = String(inputDisplayField.value).replace(/</g, '&lt;');  //html tag like structures are removed by emxGetParameter, so need protect opening character
    inputField.setAttribute("value", newValue);
	inputOIDField.setAttribute("value", newValue); //Fix IR-954974
