...
<%
	...
	if(reportGenerationName != null) {
		...
		contentURLBuf.append("=");
		contentURLBuf.append(LegacyJSPSupport.encodeUTF8(reportGenerationName));
	}
	...
	if(reportGenerationTitle != null) {
		...
		contentURLBuf.append("=");
		contentURLBuf.append(LegacyJSPSupport.encodeUTF8(reportGenerationTitle));
	}
	...
	if(reportGenerationDescription != null) {
		...
		contentURLBuf.append("=");
		contentURLBuf.append(LegacyJSPSupport.encodeUTF8(reportGenerationDescription));	
	}
	...
	if(targetDocumentId != null) {
		contentURLBuf.append("&");
		contentURLBuf.append("targetDocumentOID");
		contentURLBuf.append("=");
	...
	CATRgnIReportTemplate templateRepresentation = CATRgnReportServices.getTemplateRepresentation(reqInfo, reportModelId);
	...
	contentURLBuf.append("=");
	contentURLBuf.append(LegacyJSPSupport.encodeUTF8(emxGetParameter(request, fieldName)));
	fieldName = RGNUtil.InputValue(i);
	contentURLBuf.append("&"); 
	contentURLBuf.append(fieldName);
	contentURLBuf.append("=");
	contentURLBuf.append(XSSUtil.encodeForURL(context, emxGetParameter(request, fieldName)));
	fieldName = RGNUtil.InputName(i);
	contentURLBuf.append("&"); 
	contentURLBuf.append(fieldName);
	contentURLBuf.append("=");
	contentURLBuf.append(LegacyJSPSupport.encodeUTF8(param.getDisplay()));
	fieldName = RGNUtil.InputType(i);
	contentURLBuf.append("&"); 
	contentURLBuf.append(fieldName);
	contentURLBuf.append("=");
	contentURLBuf.append(LegacyJSPSupport.encodeUTF8(param.getTypeName()));
		}
	}
    ...
    if(filterView != null) {
		contentURLBuf.append("&");
        contentURLBuf.append("filterView");
        contentURLBuf.append("=");
        contentURLBuf.append(filterView);
    }
