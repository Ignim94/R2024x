...
<% 
	...
	if("".equals(relId) || ("null".equals(relId))|| relId == null){
        ...
        lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_CONFIGURATION_FEATURES +"].id");
        lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_VARIANT_VALUES +"].id");
        lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_GROUPED_VARIABILITY_CRITERIA +"].id");
        lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_CONFIGURATION_FEATURES +"].to.id");
        lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_VARIANT_VALUES +"].to.id");
        lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_GROUPED_VARIABILITY_CRITERIA +"].to.id");
        
        DomainObject ProductORCFObject = new DomainObject(immdParentOID);
        Map mapOfRelIds                = ProductORCFObject.getInfo(context, strSelect, lstMultiValueList);
