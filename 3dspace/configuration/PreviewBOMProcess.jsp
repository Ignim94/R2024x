...
{ 
      ...
      {        
    	  ...
    	  //e2w code    	  
          String persistedStatus = domObj.getAttributeValue(context, PropertyUtil.getSchemaProperty(context,"attribute_CompletenessStatus"));
		  System.out.println("Persisted Status = " + persistedStatus);
    	  com.dassault_systemes.enovia.configuration.modeler.ProductConfiguration pcObjectModeler = new com.dassault_systemes.enovia.configuration.modeler.ProductConfiguration(strObjectId);
    	  
    	  Map pcObjectAttr = pcObjectModeler.validateForRuleConsistencyAndCompleteness(context, false, false);
    	  String realStatus = (String)pcObjectAttr.get("CompletenessStatus");
          System.out.println("Real Status = " + realStatus);
      	  if(realStatus !=null && !realStatus.equals(persistedStatus)) {         		
         		String strOutOfDatePC = i18nNow.getI18nString("emxProduct.Alert.OutOfDateConfiguration",bundle,acceptLanguage);         		  
         		%>
         		<script language="javascript" type="text/javascript">
         		  alert("<%=XSSUtil.encodeForJavaScript(context,strOutOfDatePC)%>");
         		 </script>
         		<%
         	  }
    	  ...
    	  if(isPendingJobConnected){
    		  ...
    		  <%
    	} else if(realStatus !=null && "Complete".equals(realStatus)) {
