...
try
 ...
 %>
   ...
   var url= "../configuration/CreateRuleDialog.jsp?modetype=copy&commandName=FTRBooleanCompatibilityRuleSettings&ruleType=BooleanCompatibilityRule&SuiteDirectory=configuration&suiteKey=configuration&productID=<%=XSSUtil.encodeForURL(context,contextOID)%>&relId=null&suiteKey=configuration&objectId=<%=XSSUtil.encodeForURL(context,strObject)%>&submitURL=../configuration/BCRCopyPostProcess.jsp?objectId=<%=XSSUtil.encodeForURL(context,strObject)%>";
