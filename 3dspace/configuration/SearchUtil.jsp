	         ...
	         try{
	 			 ...
	 			 if (strSearchMode.equals("Milestone"))
	             {
				 ...
				 } else if (strSearchMode.equals("CustomChooser") || strSearchMode.equals("FormChooser"))
	              {
	                  ...
	                  selectables.add("to["+ConfigurationConstants.RELATIONSHIP_MAIN_PRODUCT+"].from.physicalid");
	                  selectables.add("to["+ConfigurationConstants.RELATIONSHIP_PRODUCTS+"].from.physicalid");
	                  ...
	                  String strModelPhyId = (String)mapUsedResult.get("to["+ConfigurationConstants.RELATIONSHIP_MAIN_PRODUCT+"].from.physicalid");
	                	if(strModelPhyId==null || strModelPhyId.equals("")){
	                		strModelPhyId = (String)mapUsedResult.get("to["+ConfigurationConstants.RELATIONSHIP_PRODUCTS+"].from.physicalid");
	                	}
	                  ...
	                  %>
	                  <script language="javascript" type="text/javaScript">
	                  		var vhiddenModelId = getTopWindow().getWindowOpener().document.getElementsByName("hidModelId");
	                  		var vtxtProductContext = getTopWindow().getWindowOpener().document.getElementsByName("txtProductContext");
							if(vhiddenModelId[0] != null && vhiddenModelId[0] != undefined)
							{
    							vhiddenModelId[0].value = "<%=XSSUtil.encodeForJavaScript(context,strModelPhyId)%>" ;
							}
		              ...
		              if(strModeValue != null && !"".equalsIgnoreCase(strModeValue) && !"null".equalsIgnoreCase(strModeValue))
		              {
		               if(strModeValue.equalsIgnoreCase("BasedOn"))
		               {
		           	  ...
		           	  %>
		                    ...
		                    if(vtxtProductContext[0] != null && vtxtProductContext[0] != undefined)
							{	
								vtxtProductContext[0].value = "<%=XSSUtil.encodeForJavaScript(context,strContextObjectName)%>" ;
							}
		             ...
		             %>
		                 <script language="javascript" type="text/javaScript">
		                 	if(vtxtProductContext[0] != null && vtxtProductContext[0] != undefined)
							{	
		                 		vtxtProductContext[0].value = "<%=XSSUtil.encodeForJavaScript(context,"")%>";
							}
			                  obj = getTopWindow().getWindowOpener().document.getElementById("btnProductContext");
			                  if(obj.disabled)
			                  obj.disabled = false;
		             ...
		             <%
		               ...
		               if(strModeValue.equalsIgnoreCase("LogicalFeatureCopyFrom")){
		            	   ...
		            	   if(isLeafLevel.equalsIgnoreCase("Yes")){
			            	   ...
			            	   strAppendURL = XSSUtil.encodeForURL(context, strAppendURL);
		            	   %>
		            	   <script language="javascript" type="text/javascript">
