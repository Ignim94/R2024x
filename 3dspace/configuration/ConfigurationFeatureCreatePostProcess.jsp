...
<%
  try
  {
      ...
      if(lstCFSubTypes.contains(featureType) && !strUIContext.equalsIgnoreCase("GlobalActions")){
    	  ...
    	  lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_CONFIGURATION_FEATURES+"].from.id");
    	  lstMultiValueList.add("to["+ConfigurationConstants.RELATIONSHIP_CONFIGURATION_FEATURES+"].id");
	      Map cfMap = (Map) domObj.getInfo(context, lstObjSelect, lstMultiValueList);
