	      ...
	      if(arrTableRowIds[0].endsWith("|0"))
	      {
	         ...
	         <%
    	      ...
    	      if(!isCFCO){
        	      ...
        	      session.putValue("strSelectedTableIdsInSession",strSelectedTableIds);  
        	      System.out.println("<---------------------------------------------------In VariabilityAllocationPreProcess.jsp: ");
                  ...
                  <script language="javascript" type="text/javaScript">          
                   var urlStr= "../common/emxIndentedTable.jsp?program=ConfigurationFeature:getVariabilityStructureAllocationMatixProductContext"+
                  	  "&freezePane=DisplayName"+
                 		  ...
                 		  "&submitURL=../configuration/emxCloseSlideInDialog.jsp" +
                 		  "&jpoAppServerParamList=session:strSelectedTableIdsInSession";
                   getTopWindow().showSlideInDialog(urlStr, "false","","","600");
                  </script>
                  <%
    	      }
	      }		  
	  }else{//when no Variants are selected for allocation
	      %>
          <script language="javascript" type="text/javaScript">          
           var urlStr= "../common/emxIndentedTable.jsp?program=ConfigurationFeature:getVariabilityStructureAllocationMatixProductContext"+
          	  "&freezePane=DisplayName"+
