     ...
     if((strRuleId!=null && !strRuleId.equals("")) || ((strRuleId!=null && !strRuleId.equals(""))))
      ...
      }else
      {
    	...
    	if( ("".equals(strRelId)) || ("null".equals(strRelId))|| strRelId == null){
            ...
            lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_CONFIGURATION_OPTIONS +"].id");
            lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_CONFIGURATION_FEATURES +"].to.id");
            lstMultiValueList.add("from["+ ConfigurationConstants.RELATIONSHIP_CONFIGURATION_OPTIONS +"].to.id");
